            ...
            CUDAExtension(name='fused_adam_cuda',
                          ...
                          extra_compile_args={'cxx': ['-O3',] + version_dependent_macros,
                                              'nvcc':['-O3',
                                                      '--use_fast_math'] + version_dependent_macros}))
        # ext_modules.append(
        #     CUDAExtension(name='fused_adam_cuda_1',
        #                   sources=['apex/contrib/csrc/optimizers/fused_adam_cuda_1.cpp',
        #                            'apex/contrib/csrc/optimizers/fused_adam_cuda_kernel_1.cu'],
        #                   include_dirs=['csrc'],
        #                   extra_compile_args={'cxx': ['-O3',] + version_dependent_macros,
        #                                       'nvcc':['-O3',
        #                                               '--use_fast_math'] + version_dependent_macros}))
