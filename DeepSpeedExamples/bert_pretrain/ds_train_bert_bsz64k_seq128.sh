...
JOB_NAME=bert_large_lamb_seq128_bsz128_similarity${similarity_target}_bszbound${bszbound}k
...
--batchsize_upper_bound $((${bszbound}*1024))  \
--deepspeed \
...
--lr_offset 10e-4 \
--job_name $JOB_NAME \
--deepspeed_config ${base_dir}/deepspeed_bsz128_lamb_config_seq128.json \
