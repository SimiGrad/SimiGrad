...
NGPU_PER_NODE=$1
MODEL_FILE=/turing-hdd/users/conglli/bert_model_outputs/saved_models/lamb_32k_chkpt150_seq512_baseline/epoch170_step7033/mp_rank_00_model_states.pt
# MODEL_FILE=../half_batch_flexible/bert_model_outputs/saved_models/bert_large_lamb_seq128_bsz64k_warmup_baseline_seq512_170epoch/epoch170_step7033/mp_rank_00_model_states.pt
SQUAD_DIR=/data/BingBertSquad
OUTPUT_DIR=./outputs/debug_conglongckpt
LR=${5:-0.00003}
SEED=${6:-12345}
MASTER_PORT=${7:-29500}
DROPOUT=${8:-0.1}
